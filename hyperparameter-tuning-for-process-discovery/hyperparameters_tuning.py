...
parser.add_argument('--results-path', dest='results_path', type=str, help='the path that results will be stored')
...
dataset = re.search('([A-Za-z0-9_-]+)\.xes', args.event_log_path).group(1)
